...
export default function ForgotPasswordPage() {
   ...
   const handleSubmit = (e: React.FormEvent) =>{
    e.preventDefault();
    setMensaje('Te hemos enviando un enlace por el correo asignado para cambiar tu contraseña.');
    setTimeout(() => navigate('/'), 300);
   };

    return (
        <div className="login-container">
            <img src={ForgotPasswordIcon} alt="ForgotPassword" className="forgot-password-icon"/>
